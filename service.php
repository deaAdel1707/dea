                    ...
                    <div class="owl-carousel service-carousel">
                        <div class="service-item">
                            ...
                            <div class="position-relative text-center bg-light rounded p-4 pb-5" style="margin-top: -75px;">
                                <h5 class="font-weight-semi-bold mt-5 mb-3 pt-5">Bowl creamy</h5>
                                <p>menu bets seller pertama di toko kami</p>
                                <a href="index.php" class="border-bottom border-secondary text-decoration-none text-secondary">Learn More</a>
                            </div>
                        </div>
                        <div class="service-item">
                            <div class="service-img mx-auto">
                            ...
                            <div class="position-relative text-center bg-light rounded p-4 pb-5" style="margin-top: -75px;">
                                <h5 class="font-weight-semi-bold mt-5 mb-3 pt-5">smooties ice cream</h5>
                                <p>perpaduan yang pas antara creamy nya vanila dengan susu</p>
                                <a href="index.php" class="border-bottom border-secondary text-decoration-none text-secondary">Learn More</a>
                            </div>
                        </div>
                        <div class="service-item">
                            ...
                            <div class="position-relative text-center bg-light rounded p-4 pb-5" style="margin-top: -75px;">
                                ...
                                <p>kualitas ice cream dengan nuah peach segar</p>
                                <a href="index.php" class="border-bottom border-secondary text-decoration-none text-secondary">Learn More</a>
                            </div>
                        </div>
                        <div class="service-item">
                            ...
                            <div class="position-relative text-center bg-light rounded p-4 pb-5" style="margin-top: -75px;">
                                <h5 class="font-weight-semi-bold mt-5 mb-3 pt-5">vanila fruty</h5>
                                <p>buah segar melimpah di tambah dengan creamy nya vanila smooties</p>
                                <a href="index.php" class="border-bottom border-secondary text-decoration-none text-secondary">Learn More</a>
                            </div>
                        </div>
                    </div>
